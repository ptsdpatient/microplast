            ...
            <>
                <div className="header" style={{ width: '100%',height:'7rem', backgroundColor: '#dedede', boxShadow: '2px 3px 6px 2px #808080',overflowX:'auto' }}>
                    <div style={{ width: '96%', height: '100%', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', margin: 'auto' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center' }} ><img alt="callIcon" src={callIcon} style={{ width: '1.5rem', height: '1.5rem', margin: '1vw', userSelect: 'none' }}></img> <div><p className={props.truncate ? "addressTruncate" : ""} style={{fontFamily:'sans-serif',fontSize:'1rem'}}>+91 9890916981 <br></br>+91 902169878</p></div></div>
