    ...
    if (!props.mobile) {
        ...
        return (<>
            ...
            <div style={{ position:'absolute',zIndex:'10000',backgroundColor:'#dedede', display: dropdownActive ? 'flex' : 'none', flexDirection: 'row', width: '100%', height: '20rem', justifyContent: 'start', margin: 'auto', alignItems: 'flex-start', gap: '2rem' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center' }} ><img alt="callIcon" src={callIcon} style={{ width: '1.5rem', height: '1.5rem', margin: '1rem', userSelect: 'none' }}></img> <div><p style={{fontFamily:'sans-serif'}} className={props.truncate ? "addressTruncate" : ""}>+91 9890916981 <br></br>+91 9021698788</p></div></div>
