...
const Footer = (props) => {
    ...
    const [officeMapSelection,setOfficeMapSelection] = useState(false)
     ...
     return (<>
            <div style={{width:'100%',height:props.mobile?'58rem':'32rem',backgroundColor:'#dedede',marginTop:'2rem',boxShadow:'2px 3px 6px 2px #808080'}}>
                <br></br>
            ...
            <div style={{width:props.mobile?'100%':'50%',height:'95%',display:'flex',flexDirection:'column'}}>
                <p style={{width:'100%',fontFamily:'sans-serif',textAlign:'center',marginTop:'1rem',marginBottom:'1.8rem',fontSize:'2rem'}}>Get in touch</p>
                <div style={{width:'100%',display:'flex'}}>
                
                <div style={{width:'40%',height:'100%'}}>
                <div className="iconBox-footer">
                <div ><img src={websiteVisitIcon}></img><div><h4>8732</h4><p>visits</p></div> </div>
                <div><img src={cementIcon}></img><div><h4>8M</h4><p>products produced</p></div></div>
            ...
            <div style={{display:'flex',width:'60%',height:'2rem',justifyContent:'space-around',margin:'auto'}}><div><img src={officeIcon} style={{width:'1.5rem',height:'1.5rem',margin:'0rem',marginTop:'0.6rem',marginRight:'0.6rem'}}></img><p className='underline-paragraph' style={{margin:'0rem',marginTop:'0.5rem',fontSize:officeMapSelection?'1.7vw':'1.5vw'}} onClick={()=>{setOfficeMapSelection(true)}}>Office</p></div><div><img src={factoryIcon} style={{width:'1.5rem',height:'1.5rem',margin:'0rem',marginTop:'0.6rem',marginRight:'0.6rem'}} ></img><p className='underline-paragraph' style={{margin:'0rem',marginTop:'0.5rem',fontSize:officeMapSelection?'1.5vw':'1.7vw'}} onClick={()=>setOfficeMapSelection(false)}>Factory</p></div> </div>
            ...
            <p style={{fontFamily:'sans-serif' }}>© Copyright 2023. All Rights Reserved. Designed by Tanishq Dhote</p>
            ...
            <p style={{fontFamily:'sans-serif',width:'100%'}}>9359721860</p>
            </div>
