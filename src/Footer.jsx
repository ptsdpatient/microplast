...
const Footer = (props) => {
    ...
    const [officeMapSelection,setOfficeMapSelection] = useState(false)
     ...
     return (<>
            ...
            <div style={{display:'flex',width:'60%',height:'2rem',justifyContent:'space-around',margin:'auto'}}><div><img src={officeIcon} style={{width:'1.5rem',height:'1.5rem',margin:'0rem',marginTop:'0.6rem',marginRight:'0.6rem'}}></img><p className='underline-paragraph' style={{margin:'0rem',marginTop:'0.5rem',fontSize:officeMapSelection?'1.1rem':'1rem'}} onClick={()=>{setOfficeMapSelection(true)}}>Office</p></div><div><img src={factoryIcon} style={{width:'1.5rem',height:'1.5rem',margin:'0rem',marginTop:'0.6rem',marginRight:'0.6rem'}} ></img><p className='underline-paragraph' style={{margin:'0rem',marginTop:'0.5rem',fontSize:officeMapSelection?'1rem':'1.2rem'}} onClick={()=>setOfficeMapSelection(false)}>Factory</p></div> </div>
            ...
            <div style={{width:'10.5rem' ,display:'flex',flexDirection:'row',justifyContent:'space-around',alignItems:'center'}}>
