...
const CompanyProfile = (props) => {
    ...
    <div style={{position:'relative',width:'100%',height:'56.25%'}}>
        ...
        <p style={{width:'100%',textAlign:'center',height:'100%',fontSize:props.mobile?'4vw':'4vw',color:'snow',textShadow:'3px 3px 2px black',userSelect:'none'}}>Welcome to M/s Microplast Polytex Industries Pvt. Ltd.</p>
        <p style={{width:'80%',fontFamily:'sans-serif',textAlign:'center',margin:'auto',height:'100%',fontSize:props.mobile?'3.2vw':'3vw',color:'snow',textShadow:'3px 3px 2px black',userSelect:'none'}}>Nestled in the picturesque locale of Jamb, within the vibrant landscape of Samudrapur, District Wardha, Maharashtra, India, stands M/s Microplast Polytex Industries Pvt. Ltd. This innovative and dynamic plastic bag manufacturing company has carved its name as a pioneer in the realm of P.P. woven products.</p>
    ...
    <div style={{width:'100%',height:'auto',display:'flex',flexDirection:'column',backgroundColor:'#dedede',justifyContent:'space-around'}}>
        ...
        <div style={{width:'90%',justifyContent:'start',display:'flex',backgroundColor:'#dedede',fontSize:'2vw',padding:'1rem',margin:'auto'}}><div style={{position:'relative'}}><p style={{width:'100%',position:'absolute',marginTop:'7vw',margin:'auto',textAlign:'center',top:'7vw',fontSize:'2.5vw',color:'snow',textShadow:'2px 2px 2px black'}}>Fertilizer Sacks</p><img src={productImage1} style={{width:'12vw',height:'10vw',margin:'auto'}}></img></div><div style={{width:'70%',margin:'auto',backgroundColor:'#cecece',height:'auto',borderRadius:'20px',paddingLeft:'2rem',overflowY:props.mobile?'auto':'hidden'}}> <p style={{fontFamily:'sans-serif',width:'92%',height:'80%',fontSize:props.mobile?'1rem':'1.3rem',textShadow:'1px 1px 1px #cecece'}}>We produce and provide a diverse range of Fertilizer Sacks, known for their water resistance, quality finish, and durability, made from top-notch materials and available in various sizes and types to suit client needs.</p></div></div>
        <div style={{width:'90%',justifyContent:'end',display:'flex',backgroundColor:'#dedede',fontSize:'2vw',padding:'1rem',margin:'auto'}}><div style={{width:'70%',margin:'auto',backgroundColor:'#cecece',height:'auto',borderRadius:'20px',paddingLeft:'2rem',overflowY:props.mobile?'auto':'hidden'}}> <p style={{fontFamily:'sans-serif',width:'92%',height:'80%',fontSize:props.mobile?'1rem':'1.3rem',textShadow:'1px 1px 1px #cecece'}}>Our PP Woven Fabric offers reliable and cost-effective packaging solutions for various industries worldwide.</p></div><div style={{position:'relative'}}><p style={{width:'100%',position:'absolute',marginTop:'7vw',margin:'auto',textAlign:'center',top:'7vw',fontSize:'2.5vw',color:'snow',textShadow:'2px 2px 2px black'}}>HDPE Fabrics</p><img src={productImage2} style={{width:'14vw',height:'10vw',margin:'auto'}}></img></div></div>
        <div style={{width:'90%',justifyContent:'start',display:'flex',backgroundColor:'#dedede',fontSize:'2vw',padding:'1rem',margin:'auto'}}><div style={{position:'relative'}}><p style={{width:'100%',position:'absolute',marginTop:'7vw',margin:'auto',textAlign:'center',top:'7vw',fontSize:'2.5vw',color:'snow',textShadow:'2px 2px 2px black'}}>Gussetted Bags</p><img src={productImage3} style={{width:'12vw',height:'10vw',margin:'auto'}}></img></div><div style={{width:'70%',margin:'auto',backgroundColor:'#cecece',height:'auto',borderRadius:'20px',paddingLeft:'2rem',overflowY:props.mobile?'auto':'hidden'}}> <p style={{fontFamily:'sans-serif',width:'92%',height:'80%',fontSize:props.mobile?'1rem':'1.3rem',textShadow:'1px 1px 1px #cecece'}}>PP woven laminated gusseted bags maximize vertical storage capacity with their unique design, making them perfect for storing agri products and food grains while efficiently utilizing space.</p></div></div>
        <div style={{width:'90%',justifyContent:'end',display:'flex',backgroundColor:'#dedede',fontSize:'2vw',padding:'1rem',margin:'auto'}}><div style={{width:'70%',margin:'auto',backgroundColor:'#cecece',height:'auto',borderRadius:'20px',paddingLeft:'2rem',overflowY:props.mobile?'auto':'hidden'}}> <p style={{fontFamily:'sans-serif',width:'92%',height:'80%',fontSize:props.mobile?'1rem':'1.3rem',textShadow:'1px 1px 1px #cecece'}}>Our P.P. woven fabric is meticulously crafted using advanced techniques, ensuring durability and versatility for various industrial applications.</p></div><div style={{position:'relative'}}><p style={{width:'100%',position:'absolute',marginTop:'7vw',margin:'auto',textAlign:'center',top:'7vw',fontSize:'2.5vw',color:'snow',textShadow:'2px 2px 2px black'}}>Woven Fabrics</p><img src={productImage4} style={{width:'14vw',height:'10vw',margin:'auto'}}></img></div></div>
        <div style={{width:'90%',justifyContent:'start',display:'flex',backgroundColor:'#dedede',fontSize:'2vw',padding:'1rem',margin:'auto'}}><div style={{position:'relative'}}><p style={{width:'100%',position:'absolute',marginTop:'7vw',margin:'auto',textAlign:'center',top:'7vw',fontSize:'2.5vw',color:'snow',textShadow:'2px 2px 2px black'}}>Woven Sacks</p><img src={productImage5} style={{width:'12vw',height:'10vw',margin:'auto'}}></img></div><div style={{width:'70%',margin:'auto',backgroundColor:'#cecece',height:'auto',borderRadius:'20px',paddingLeft:'2rem',overflowY:props.mobile?'auto':'hidden'}}> <p style={{fontFamily:'sans-serif',width:'92%',height:'80%',fontSize:props.mobile?'1rem':'1.3rem',textShadow:'1px 1px 1px #cecece'}}>We provide a comprehensive selection of polypropylene woven bags and sacks with liners, designed to safeguard and securely package materials like chemicals, fertilizers, animal feed, and more, all produced in our advanced manufacturing facility.</p></div></div>
        <div style={{width:'90%',justifyContent:'end',display:'flex',backgroundColor:'#dedede',fontSize:'2vw',padding:'1rem',margin:'auto'}}><div style={{width:'70%',margin:'auto',backgroundColor:'#cecece',height:'auto',borderRadius:'20px',paddingLeft:'2rem',overflowY:props.mobile?'auto':'hidden'}}> <p style={{fontFamily:'sans-serif',width:'92%',height:'80%',fontSize:props.mobile?'1rem':'1.3rem',textShadow:'1px 1px 1px #cecece'}}>These woven polypropylene bags are exceptionally durable and versatile, serving as robust packaging solutions for various industries such as grain, milling, sugar, fodder, chemicals, fertilizers, cement, and more; we provide fully customized designs to meet each customer's specific needs.</p></div><div style={{position:'relative'}}><p style={{width:'100%',position:'absolute',marginTop:'7vw',margin:'auto',textAlign:'center',top:'7vw',fontSize:'2.5vw',color:'snow',textShadow:'2px 2px 2px black'}}>Woven Bags</p><img src={productImage6} style={{width:'14vw',height:'10vw',margin:'auto'}}></img></div></div>
        <div style={{width:'90%',justifyContent:'start',display:'flex',backgroundColor:'#dedede',fontSize:'2vw',padding:'1rem',margin:'auto'}}><div style={{position:'relative'}}><p style={{width:'100%',position:'absolute',marginTop:'7vw',margin:'auto',textAlign:'center',top:'7vw',fontSize:'2.5vw',color:'snow',textShadow:'2px 2px 2px black'}}>Rice Bags</p><img src={productImage7} style={{width:'12vw',height:'10vw',margin:'auto'}}></img></div><div style={{width:'55%',margin:'auto',backgroundColor:'#cecece',height:'auto',borderRadius:'20px',paddingLeft:'2rem',overflowY:props.mobile?'auto':'hidden'}}> <p style={{fontFamily:'sans-serif',width:'92%',height:'80%',fontSize:props.mobile?'1rem':'1.3rem',textShadow:'1px 1px 1px #cecece'}}>Our high-quality PP Rice Bags, specially designed for packing rice and food grains, offer durability, customization options, water resistance, and effective preservation of packed contents, all verified through rigorous industrial quality checks.</p></div></div>
