    ...
    <div style={{width:props.mobile?'95%':'80%',margin:'auto',marginTop:'1.5rem',borderRadius:'25px'}}>
        <div style={{display:'flex',flexDirection:'column',width:'100%'}}>
            ...
            <div style={{width:'46%',borderRadius:'25px',display:'flex',flexDirection:'column'}}>
                ...
                <div style={{display:'flex',justifyContent:'space-between'}}><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}>Double Flat : </p><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}> 30 to 90 cm</p></div>
                <div style={{display:'flex',justifyContent:'space-between'}}><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}>No. of shuttles : </p><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}> 6</p></div>
            ...
            <div style={{width:'46%',borderRadius:'25px',display:'flex',flexDirection:'column'}}>
                ...
                <div style={{display:'flex',justifyContent:'space-between'}}><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}>Weft insertion rate : </p><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}> 1100ppm</p></div>
                <div style={{display:'flex',justifyContent:'space-between'}}><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}>No. of tapes : </p><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}> 576/720</p></div>
            ...
            <div style={{width:'46%',borderRadius:'25px',display:'flex',flexDirection:'column'}}>
                ...
                <div style={{display:'flex',justifyContent:'space-between'}}><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}>Internal diameter : </p><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}> 35mm**</p></div>
                <div style={{display:'flex',justifyContent:'space-between'}}><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}>Length of core : </p><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}> 218mm**</p></div>
                <div style={{display:'flex',justifyContent:'space-between'}}><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}>Max. bobbin diameter : </p><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}> 160mm**</p></div>
                <div style={{display:'flex',justifyContent:'space-between'}}><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}>Length of traverse : </p><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}> 200mm</p></div>
            ...
            <div style={{width:'46%',borderRadius:'25px',display:'flex',flexDirection:'column'}}>
                ...
                <div style={{display:'flex',justifyContent:'space-between'}}><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}>Internal diameter : </p><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}> 35mm**</p></div>
                <div style={{display:'flex',justifyContent:'space-between'}}><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}>Length of core : </p><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}> 218mm**</p></div>
                <div style={{display:'flex',justifyContent:'space-between'}}><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}>Max. bobbin diameter : </p><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}> 115mm</p></div>
                <div style={{display:'flex',justifyContent:'space-between'}}><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}>Length of traverse : </p><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}> 200mm</p></div>
            ...
            <div style={{width:'46%',borderRadius:'25px',display:'flex',flexDirection:'column'}}>
                ...
                <p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2.2vw',textAlign:'center',backgroundColor:'#1b1b1b',borderRadius:'1rem',color:'snow'}}>Creel capacity</p>
                <div style={{display:'flex',justifyContent:'space-between'}}><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}>Bobbins per machine : </p><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}> 576</p></div>
            ...
            <div style={{width:'46%',borderRadius:'25px',display:'flex',flexDirection:'column'}}>
                ...
                <div style={{display:'flex',justifyContent:'space-between'}}><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}>Max. roll diameter : </p><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}> 1500mm</p></div>
            ...
            <div style={{width:'100%',borderRadius:'25px',display:'flex',flexDirection:'column',paddingTop:'0.5rem'}}>
                ...
                <div style={{display:'flex',justifyContent:'space-between'}}><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}>Length x Width x Height x Center (for 576 tapes) : </p><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}> 9.7 x 2.8 x 3.0 x 2.2 m</p></div>
                <div style={{display:'flex',justifyContent:'space-between'}}><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}>Length x Width x Height x Center (for 720 tapes) : </p><p style={{padding:'1vw',textShadow:'1px 1px 2px #1b1b1b',margin:'0rem',fontSize:props.mobile?'3.5vw':'2vw'}}> 10.3 x 2.8 x 3.0 x 2.2 m </p></div>
